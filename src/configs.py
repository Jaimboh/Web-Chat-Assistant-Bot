...
class Settings(BaseSettings):
    # Application
    PROJECT_NAME: str = "chat_assistan_tbot"
    PROJECT_DESCRIPTION: str = "Jaimboh's web buddy powered by OpenAI."
    COMPANY_NAME: str = "Jaimboh Tech"
    COMPANY_EMAIL: str = "hello@jaimboh.com"
